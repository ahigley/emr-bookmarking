...
docker build -t sample_job-emr-launcher -f docker_launch/Dockerfile .
docker tag sample_job-emr-launcher:latest "$ACCOUNT".dkr.ecr.us-east-1.amazonaws.com/sample_job-emr-launcher:latest
docker push "$ACCOUNT".dkr.ecr.us-east-1.amazonaws.com/sample_job-emr-launcher:latest
